...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="/BahanStudy/images/shophouse.png">
                    ...
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="/keranjang"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <?php
                                         if($id != null) { ?>
                                        <button data-toggle="modal" data-target="#myModal" data-id="{{ $brg->id_barang }}" class="btn btn-default add-to-cart jumlah">
            ...
            <form action="/AddCart" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="text" id="id_barang" name="id_barang" class="id_barang" value="3487">
